 ...
 */
package br.com.ifba.vp.telaverificarestoque.view;
...
//Variavel usada para decidir a qual tela voltar apos fechar a tela verificar estoque.
int i;
    /**
     * Creates new form TelaVerificarEstoque
     */
    public TelaVerificarEstoque(int u) {
        //Atribuição de valor que decidirá a qual tela retornar
        i = u;
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        //Teste de valor recebido no construtor da tela, a depender do valor se escolhe para onde retornar.
        if(i == 1){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //Envia requisição ao metodo que busca produto na camada facede.
        List <Produto> PP = Singleton.getInstance().findByNomeProduto(jTextField1.getText());
        int y = 0;
        
        for(int i = 0; i < PP.size(); i++){
            y++;
            //Lista os dados encontrados na tabela.
