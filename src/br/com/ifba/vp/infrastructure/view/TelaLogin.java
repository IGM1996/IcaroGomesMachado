...
public class TelaLogin extends javax.swing.JFrame{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        try{
            //Manda uma solicitação para o metodo login na camada facede 
            for(FuncionarioCaixa F: Singleton.getInstance().Login()){
        ...
        //Número pré-cadastrado para tela de gerente
        if(cpf == 12345 && senha == 1221){
