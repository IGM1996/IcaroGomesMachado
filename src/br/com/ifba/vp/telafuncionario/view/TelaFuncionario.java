...
import br.com.ifba.vp.telaverificarestoque.view.TelaVerificarEstoque;
...
double precoTotal = 0;
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        //Guarda os dados (colunas e linhas) de uma tabela, separado do objeto tabela.
        ...
        try{
            //Envia requisição ao metodo que busca produto pelo codigo de barras na camada facede
            List <Produto> PP = Singleton.getInstance().findByCodigoBarras(Long.parseLong(jTextField1.getText()));
            for(int i = 0; i < PP.size(); i++){

                //Pega as colunas do array e passa para o objeto produto
                pr.setCodigoBarras(PP.get(i).getCodigoBarras());
                pr.setDataValidade(PP.get(i).getDataValidade());
                pr.setGenero(PP.get(i).getGenero());
                pr.setLote(PP.get(i).getLote());
                pr.setNomeProduto(PP.get(i).getNomeProduto());
                pr.setPreco(PP.get(i).getPreco());
                pr.setSecao(PP.get(i).getSecao());
                pr.setId(PP.get(i).getId());

                //Printa o preço total da compra.
                precoTotal = precoTotal + PP.get(i).getPreco();
                y++;
                modelo.addRow(new Object[]{

                    //printa dados do produto comprado
                    PP.get(i).getNomeProduto(),
                    PP.get(i).getPreco(),
                    PP.get(i).getLote(),
                    PP.get(i).getDataValidade(),
                });
                //Envia requisição a função que deleta produto na camada facede passando o objeto a ser excluido.
                Singleton.getInstance().deleteByCodigoBarras(pr);
            }
            if(y == 0){
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        //Singleton.getInstance().deleteByCodigoBarras(Long.parseLong(jTextField1.getText()));
        int y = 0;
        if(y == 0){
