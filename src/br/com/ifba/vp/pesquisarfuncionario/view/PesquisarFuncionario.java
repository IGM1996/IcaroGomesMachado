 ...
 */
package br.com.ifba.vp.pesquisarfuncionario.view;
...
public class PesquisarFuncionario extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int y = 0;
        //Manda requisição para o metodo que busca funcionario por cpf na camada facede
        List <FuncionarioCaixa> buscaCPF = Singleton.getInstance().findByCpfFuncionario(Long.parseLong(jTextField1.getText()));
        
        for(int i = 0 ; i < buscaCPF.size(); i++){
            y++;
            modelo.addRow(new Object[]{
                //Imprime dados do funcioario na tela       
